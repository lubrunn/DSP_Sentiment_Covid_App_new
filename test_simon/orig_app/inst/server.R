...
# output$dataset_start <- DT::renderDataTable ({
#   DT::datatable(final_regression_df_xgb()) %>% DT::formatStyle(names(final_regression_df_xgb()),
#                                                                lineHeight='80%',lineWidth='80%') %>% DT::formatRound(columns= final_regression_df_xgb()
#                                                                                                                      %>% dplyr::select(-Dates)
#                                                                                                                      %>% names() ,                                                                                                                  digits=2)
# })
